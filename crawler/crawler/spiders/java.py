...
class Spider(scrapy.Spider):
    ...
    def parse(self, response):
        return scrapy.Request('https://api.github.com/search/repositories?q=a+language:java&sort=stars&order=desc', callback = self.parseURL, headers = {'Authentication':'token 36cf8d89dca0f82901f7a42ec6a8397e91252795'})
